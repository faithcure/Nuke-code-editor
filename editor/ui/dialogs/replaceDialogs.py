...
class ReplaceDialogs(QDialog):
    def __init__(self, editor):
        ...
        """)
        self.replace_input.textChanged.connect(self.update_button_state)  
        ...
        self.replace_button.setStyleSheet("""
            ...
            QPushButton:disabled {
                background-color: #555555;  # Darker when disabled
            }
    ...
    def move_below_cursor(self):
        """Show the dialog below the editor cursor position."""
    ...
    def perform_replace(self):
        """Replace the word in the whole document or the selection."""
    ...
    def mousePressEvent(self, event):
        """Mouse events for dragging the dialog."""
